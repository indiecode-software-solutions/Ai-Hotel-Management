...
const GuestLanding = () => {
  ...
  const handleAiSearch = async () => {
    ...
    navigate(`/guest/search?query=${encodeURIComponent(aiQuery)}`);
  };
    ...
    <div className="guest-app-container">
      ...
      <div className={`mobile-menu-overlay ${isMenuOpen ? 'active' : ''}`}>
        ...
        <div className="menu-content">
          <div className="menu-header">
            <Link to="/guest" className="guest-logo" onClick={() => setIsMenuOpen(false)}>
              <Globe size={24} />
              <span>OASIS</span>
            </Link>
          ...
          <div className="menu-footer">
            ...
            <button className="mobile-auth-btn">Sign In to Oasis</button>
          </div>
        </div>
      </div>
        ...
        >
          ...
          <div className="hero-search-wrap fade-in-up delay-2">
            ...
            <div className="search-suggestions">
              <button onClick={() => navigate('/guest/search?query=Villas+in+Bali')}>Bali</button>
              <button onClick={() => navigate('/guest/search?query=Penthouses+in+NYC')}>New York</button>
              <button onClick={() => navigate('/guest/search?query=Resorts+in+Maldives')}>Maldives</button>
              <button onClick={() => navigate('/guest/search?query=Suites+in+Paris')}>Paris</button>
            </div>
          </div>
      ...
      <section id="hotels" className="section-container">
        <div className="section-intro reveal-on-scroll">
          ...
          <Link to="/guest/search" className="action-link">
        ...
        <div className="philosophy-layout">
          ...
          <div className="philosophy-content reveal-on-scroll">
            ...
            <p className="section-description">
              Oasis isn't just a booking platform; it's a filtration system for the world's most exceptional hospitality. We use artificial intelligence to understand the nuance of your desires, matching you with spaces that don't just house you, but inspire you.
            </p>
      ...
      <footer className="guest-footer">
        <div className="footer-content">
          ...
          <p className="copyright">© 2026 Oasis Booking. All rights reserved.</p>
        </div>
      </footer>
